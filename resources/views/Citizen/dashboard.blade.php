<x-layouts.dashboard title="Dashboard" role="citizen">
    ...
    <div
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
            ...
            <h2 class="text-xl font-bold mb-4 bg-gradient-to-r from-cyan-600 to-cyan-300 p-3 rounded-lg text-white">
                Komplain Saya
            </h2>

            @forelse($myComplaints as $complaint)
                <div class="py-2 bg-gray-100 shadow rounded-lg mb-3 px-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mt-6">
        ...
        <div class="bg-white rounded-2xl shadow p-6">
            ...
            @forelse($shelters as $shelter)
                ...
                <div class="py-3 bg-gray-100 shadow rounded-lg mb-3 px-2">
    ...
    <div class="flex items-center gap-4 mb-4 bg-gradient-to-r from-cyan-600 to-cyan-300 p-3 rounded-lg text-white">
    ...
    <div class="space-y-2 bg-gray-100 shadow rounded-lg mb-3 p-3">
