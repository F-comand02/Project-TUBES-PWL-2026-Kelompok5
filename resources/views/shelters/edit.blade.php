...
<div class="p-6">
    ...
    <form
        action="{{ route('shelters.update', $shelter->id) }}"
        method="POST"
        ...
        <div>
            ...
            <textarea
            name="address"
            class="w-full border rounded-xl p-3">{{ $shelter->address }}</textarea>
        ...
        <div>
            ...
            value="{{ $shelter->current_refugees }}"
            class="w-full border rounded-xl p-3">
        ...
        <div>
            ...
            <select
                ...
                <option
                value="active"
                {{ $shelter->status == 'active' ? 'selected' : '' }}>
                Active
                </option>
